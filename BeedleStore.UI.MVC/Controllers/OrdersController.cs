...
namespace BeedleStore.UI.MVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(BeedleStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var beedleStoreContext = _context.Orders.Include(o => o.User);
            return View(await beedleStoreContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BeedleStoreContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
